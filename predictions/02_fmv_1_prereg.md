...
> **DRAFT — NOT YET LOCKED.** Under author review. The canonical
> content below the LOCK BOUNDARY is not frozen until
> `scripts/lock_prereg.py` runs and tags `prereg-02_fmv.1-locked`.
