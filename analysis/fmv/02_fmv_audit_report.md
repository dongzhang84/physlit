...
- Claude judge vs human: **12/14 (86%)**
...
v0.1 Aristotelian: OpenAI 68% agreement, Claude 32%. F=mv: Claude 86%, OpenAI 21%. Same judge prompts, same models, completely reversed performance. This is a paper-level finding.
...
1. Apply these 14 verdicts to the aggregator. Recompute P1/P2/P3/P4.
2. Add the judge-reliability-reversal finding to `02_fmv_findings.md`.
3. Flag the OpenAI verdict-field bug as a known systematic defect — consider adding a post-hoc consistency check (if reasoning says "should pass" but verdict says FAIL, flag for review).
